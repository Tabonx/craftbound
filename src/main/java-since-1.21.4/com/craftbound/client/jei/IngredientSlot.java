...
// This generation of JEI names every one of these "add" and still asks for the tooltip callback it
// later removed. They all funnel into the same place: whatever the slot accepts, recorded as a
// typed ingredient.
