...
public class Craftbound
{
    ...
    public static final DeferredHolder<CreativeModeTab, CreativeModeTab> EXAMPLE_TAB = CREATIVE_MODE_TABS.register("example_tab", () -> CreativeModeTab.builder()
            .title(Component.translatable("itemGroup.craftbound")) //The language key for the title of your CreativeModeTab
    ...
    public Craftbound(IEventBus modEventBus, ModContainer modContainer)
    {
        ...
        // Note that this is necessary if and only if we want *this* class (Craftbound) to respond directly to events.
